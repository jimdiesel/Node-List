var querystring = require("querystring"),
	...
	loginPage = require("../views/user/page/login"),
	createPage = require("../views/user/page/create"),
	userPage = require("../views/user/page/index"),
	editPage = require("../views/user/page/edit"),
	deletePage = require("../views/user/page/delete"),
